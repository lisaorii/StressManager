package com.example.lisaorii.stressmeasurer;
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (rankingNum == 1 || rankingNum == 2) {
                    ...
                    Intent in2 = new Intent(MainActivity.this, Main3Activity.class);
                    startActivity(in2);
                }

                else if (rankingNum == 5) {
                    Intent in3 = new Intent(MainActivity.this, Main4Activity.class);
                    startActivity(in3);
                }
